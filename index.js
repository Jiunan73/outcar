...
init();
	function init() {
		//載入物件
				...
				// The path to the URDF within the package OR absolute
				loader1.load('../../../charger1/urdf/charger1.urdf', object => {
				...
				// The path to the URDF within the package OR absolute
				loader1.load('../../../layout1/urdf/layout1.urdf', object => {
					//object.scale.x = object.scale.y = object.scale.z = 1;
					// The robot is loaded!
				...
				loader1.load('../../../slope2/urdf/slope2.urdf', object => {
					//object.scale.x = object.scale.y = object.scale.z = 1;
					// The robot is loaded!
					//object.position.x =-0.52;
					//object.position.y = 0.525 ;
					...
					loader1.load('../../../Manhole/urdf/Manhole.urdf', object => {
					//object.scale.x = object.scale.y = object.scale.z = 1;
					// The robot is loaded!
					object.position.x =1.52;
